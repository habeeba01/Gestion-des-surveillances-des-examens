						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="tab1">
								<table class="table table-striped">
								  <thead>
								    <tr>
								      									<th scope='col'>nomelem</th>
										<th scope='col'>coeff</th>
										<th scope='col'>noteelem</th>
								  ...
								  <tbody>
                                    <tr v-for="elemen in element" :key="elemen." >
																			<td>{{elemen.nomelem}}</td>
										<td>{{elemen.coeff}}</td>
										<td>{{elemen.noteelem}}</td>
										<td>{{elemen.nommod}}</td>
										<td>{{elemen.idens}}</td>
	
										<td><button  class="btn btn-primary" @click="selectElemen(elemen)"><em class="fa fa-file-o"></em></button></td>
                                    </tr>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <elemenForm-component></elemenForm-component>	
...
<elemenEdit-component  :elemen="elemen" :editMethod="editMethod" @toggleEdit="editMethod = !editMethod" v-if="editMethod" ></elemenEdit-component>
...
<script>
    export default {
        ...
        mounted() {
            console.log('elemen Component mounted.')
        },
        data()
        {
            return {
        ...
        created()
        {
            axios.get('http://localhost:8000/api/element'
            ).then(response => 
